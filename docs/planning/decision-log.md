...
| 價格歷史有使用者價值，但不等於個人化價格追蹤 | 價格歷史、近期漲跌與分享配單中的價格變動提示可作為決策輔助；使用者訂閱商品、watchlist、到價提醒或個人價格通知會引入身份、通知通道、偏好保存、退訂、防濫用與資料新鮮度承諾，第三版不自然延伸這些功能。 |
| 使用者向 Discord 限定為公開價格變動與分享輔助 | 第三版第一輪只保留 public 價格變動清單與商品連結 Open Graph / share action；公開服務狀態推播、分享配單預覽與一般公告暫不做。仍不做 Discord 查詢指令、私訊通知、帳號綁定、Discord 內保存配單、個人商品追蹤、到價提醒或購買建議。 |
| Discord 資料更新摘要第一輪採公開變價清單 | 第一輪 public webhook 由 `crawler-daemon` 在本輪有商品價格變動時送出，列出商品名稱、站內商品連結、舊價、新價與差額，並以 `PRICE_CHANGE_DISCORD_MAX_ITEMS` 控制單輪上限；不送新品、同價更新、個人化訂閱或到價提醒。 |
...
| 第三版範圍與順序已收斂 | 第三版近期主線收斂為商品頁分享 / Open Graph preview、public Discord 價格變動清單、Discord 管理者告警、外部監控、受保護的內網 ops status page、資料品質檢視與公開流量硬化；分享配單、公開服務狀態推播與公開狀態頁暫緩，詳細範圍以 [第三版 Roadmap](v3-roadmap.md) 為準。 |
...
| 項目 | 延後原因 |
| --- | --- |
| 第三版非目標群 | 使用者帳號、個人化價格追蹤、個人提醒、商品訂閱、watchlist、互動式 Discord 查詢 / 私訊 / 帳號綁定、帳號保存菜單、分類缺漏提示、規格資料、相容性檢查與自動推薦配單均不納入第三版；詳見 [第三版 Roadmap](v3-roadmap.md)。 |
