...
export const SCHEDULED_PRICE_REPORT_MAX_RETRY_ATTEMPTS = 5;
export const SCHEDULED_PRICE_REPORT_RETRY_BASE_DELAY_MS = 5 * 60 * 1000;
export const SCHEDULED_PRICE_REPORT_RETRY_MAX_DELAY_MS = 6 * 60 * 60 * 1000;
export const SCHEDULED_PRICE_REPORT_RETRY_MAX_JITTER_MS = 60 * 1000;
export const SCHEDULED_PRICE_REPORT_RETRY_AFTER_MAX_MS = 24 * 60 * 60 * 1000;
export const SCHEDULED_PRICE_REPORT_CLAIM_LEASE_MS = 15 * 60 * 1000;
