...
interface ProductFiltersProps {
  ...
  getCategoryHref: (category: CategorySlug) => string;
  onKeepDesktopOpen: (event: MouseEvent<HTMLElement>) => void;
  onToggleOpen: (isOpen: boolean) => void;
}

// 顯示來源分類 pathname links，並透過 details / summary 承接響應式收合行為。
    ...
    <aside className="filter-panel">
      <details open={filtersOpen} onToggle={(event) => onToggleOpen(event.currentTarget.open)}>
        ...
        <div className="filter-stack">
          <div>
            <nav className="category-list" aria-label="商品分類">
