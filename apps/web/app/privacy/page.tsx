    ...
    <div className="app-shell public-info-shell">
      ...
      <main className="public-info-page">
        <section className="public-info-hero">
          ...
          <p>本政策說明瀏覽網站與使用公開 API 時，為維持服務安全與功能所需的最少技術資訊。</p>
        </section>

        <section className="public-info-section">
          <h2>適用範圍</h2>
          <p>
            本政策適用於 PartsRadarTW 網站及其公開 API。前往原價屋、Discord
            或其他外部網站後，應另依該服務的政策處理。
          </p>
        </section>

        <section
          className="public-info-section public-info-launch-warning"
        ...
        <section className="public-info-section">
          ...
          <ul className="public-info-section-list">
            ...
            <li>
              限流 bucket 會暫存在程序記憶體；發生限流拒絕時，診斷紀錄使用 SHA-256 雜湊前 16
              個十六進位字元，不寫入原始 IP。兩者都不用來建立個人檔案或跨站追蹤。
            </li>
            <li>
        ...
        <section className="public-info-section">
          ...
          <p>
            Repository 目前未設定 container
            日誌輪替或保存期限。正式公開上線前，部署者必須確認實際欄位、保存期間、存取權限與刪除流程，並更新本節。
          </p>
        </section>
        ...
        <section className="public-info-section">
          <h2>分析、廣告與 Cookie</h2>
          <p>
            目前網站不使用非必要的分析服務、廣告追蹤或行銷
            Cookie。若未來實際導入，會先更新本政策與必要告知。
          </p>
        </section>
        ...
        <section className="public-info-section" id="privacy-requests">
          ...
          <p>
            ...
            僅供瀏覽公開原始碼，其 Issues 目前限制建立新
            issue，不能作為正式請求管道。聯絡準備狀態會更新於
