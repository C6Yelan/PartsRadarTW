...
import {
  ...
  DEFAULT_INVALID_IMAGE_URL_WARN_HOURS,
  DEFAULT_INVALID_IMAGE_URL_WARN_PERCENT,
  DEFAULT_INVALID_IMAGE_URL_WARN_URL_COUNT,
  DEFAULT_MIN_ACTIVE_PRODUCTS,
  DEFAULT_MISSING_IMAGE_FAIL_COUNT,
  DEFAULT_MISSING_IMAGE_FAIL_PERCENT,
  DEFAULT_MISSING_IMAGE_WARN_COUNT,
  DEFAULT_MISSING_IMAGE_WARN_PERCENT,
...
export function parseProductionSmokeOptions(
  ...
  return {
    ...
    invalidImageUrlWarnUrlCount: parseIntegerOption({
      args,
      env,
      argName: "--invalid-image-url-warn-url-count",
      envName: "SMOKE_INVALID_IMAGE_URL_WARN_URL_COUNT",
      fallback: DEFAULT_INVALID_IMAGE_URL_WARN_URL_COUNT,
      min: 0,
      max: 1000000,
    }),
    invalidImageUrlWarnPercent: parseIntegerOption({
      args,
      env,
      argName: "--invalid-image-url-warn-percent",
      envName: "SMOKE_INVALID_IMAGE_URL_WARN_PERCENT",
      fallback: DEFAULT_INVALID_IMAGE_URL_WARN_PERCENT,
      min: 0,
      max: 100,
    }),
    invalidImageUrlWarnHours: parseIntegerOption({
      args,
      env,
      argName: "--invalid-image-url-warn-hours",
      envName: "SMOKE_INVALID_IMAGE_URL_WARN_HOURS",
      fallback: DEFAULT_INVALID_IMAGE_URL_WARN_HOURS,
      min: 1,
      max: 30 * 24,
    }),
    ...
    missingImageWarnPercent: parseIntegerOption({
      args,
      env,
      argName: "--missing-image-warn-percent",
      envName: "SMOKE_MISSING_IMAGE_WARN_PERCENT",
      fallback: DEFAULT_MISSING_IMAGE_WARN_PERCENT,
      min: 0,
      max: 100,
    }),
    missingImageFailPercent: parseIntegerOption({
      args,
      env,
      argName: "--missing-image-fail-percent",
      envName: "SMOKE_MISSING_IMAGE_FAIL_PERCENT",
      fallback: DEFAULT_MISSING_IMAGE_FAIL_PERCENT,
      min: 0,
      max: 100,
    }),
